...
def display_policy_config():
    ...
    st.markdown("This determines the starting point for measuring the impact of reforms.")
    ...
    with col1:
        ...
        salt_marriage_bonus = st.checkbox(
            "Marriage Bonus",
            help="Double the SALT cap for married couples"
        )
    ...
    with col2:
        ...
        amt_repealed = st.checkbox(
            "AMT Repealed",
            help="Check to repeal the Alternative Minimum Tax"
        )
